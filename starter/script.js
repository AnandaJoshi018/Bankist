...
const calcDisplayBalence = function(acc) {
  ...
  labelBalance.textContent = `${acc.balence.toFixed(2)} RUPEES`;
}
...
btnLoan.addEventListener('click',function(e){
  e.preventDefault();
  const amount = Math.floor(inputLoanAmount.value); //.Floor returns greatest integer or equal to its numeric argument
